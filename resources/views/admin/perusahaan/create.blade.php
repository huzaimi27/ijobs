...
<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title">
            <i class="icon-cart position-left"></i> Tambah Perusahaan Baru Disini
        </h6>
    </div>

    {!!Form::open(array('url' => 'admin/perusahaan/store', 'class'=>'form-horizontal', 'files' => true ))!!}
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" placeholder="" name="website" required="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label text-semibold">Jenis Badan Usaha</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" placeholder="" name="j_badanusaha" required="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label text-semibold">Telepon</label>
                    <div class="col-lg-6">
                        <input type="number" class="form-control" placeholder="" name="telepon" required="">
                    </div>
                    <div class="col-lg-4">
                        <div class="input-group">
                            <input type="text" class="form-control"  placeholder="Masukkan Fax  perusahaan jika ada. . ." name="fax">
                        </div>
                    </div>
                </div>
